...
// location.href=queryParams;
  ...
  //fetch(`http://localhost:80/whereismyhome/api?dong=${dongCode}&DEAL_YMD=${dealYM}&aptName=${aptName}`)
  fetch(`http://localhost:80/whereismyhome/house/search?dongCode=${dongCode}&apartmentName=${aptName}`)
